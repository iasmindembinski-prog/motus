...
export function EdicoesAnteriores() {
  return (
    <section id="edicoes" className="py-24 md:py-32 px-6 lg:px-8 bg-[var(--card)]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <motion.a 
            href="http://movimentoliterariodigital.atspace.cc/edicoes.php" 
            target="_blank" 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {covers.map((cover, index) => (
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative aspect-[3/4] overflow-hidden rounded-md bg-[var(--background)] shadow-md hover:shadow-xl transition-all duration-500"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
